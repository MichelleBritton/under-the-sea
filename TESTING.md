...
| Result:   | The feature responded as expected when two cards are clicked on but it allowed you to click on more than two cards per turn. Also, double clicking on a card resulted in a pop up saying you had a (false) match.|
